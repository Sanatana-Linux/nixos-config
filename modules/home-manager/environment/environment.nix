...
with lib; let
  cfg = config.modules.environment.environment;
in {
  options.modules.environment.environment = {
    enable = mkEnableOption "shell environment configuration with paths and variables";
  };
