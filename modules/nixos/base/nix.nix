      ...
      settings = {
        ...
        substituters =
          [
            ...
            # CUDA binary cache. The legacy cuda-maintainers.cachix.org cache was
            # retired in Nov 2025 and now returns 401; the official cache moved to
            # cache.nixos-cuda.org. Only the current host is listed.
