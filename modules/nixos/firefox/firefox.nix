...
let
  ...
  if [ ! -d $out/lib/userfox/firefox-scripts ]; then
    ${pkgs.git}/bin/git clone https://github.com/Thomashighbaugh/firefox /$out/lib/userfox/firefox-scripts
    else
     rm -rvf $out/lib/userfox/firefox-scripts
     ${pkgs.git}/bin/git clone https://github.com/Thomashighbaugh/firefox /$out/lib/userfox/firefox-scripts
    fi
      ...
      cp -rvf $out/lib/userfox/firefox-scripts/patches/root/* $out/lib/userfox/
