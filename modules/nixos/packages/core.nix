...
in {
  options.modules.packages = {
    core = {
      enable = mkEnableOption "Core system utilities and libraries";
    };
  };

  config = mkIf cfg.core.enable {
    environment.systemPackages = with pkgs; [
      # Core system utilities from hosts/shared/pkgs/core.nix
      ...
      poppler_gi # GObject introspection bindings for Poppler
